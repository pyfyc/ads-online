...
public class DtoConstantsTest {
    ...
    static {
        USER_DTO = new User();
        USER_DTO.setEmail("new_user@mail.com");
        USER_DTO.setFirstName("newFirstName");
        USER_DTO.setId(1);
        USER_DTO.setLastName("newLastName");
        USER_DTO.setPhone("newPhone");

        ADS_DTO = new Ads();
        ADS_DTO.setAuthor(1);
        ADS_DTO.setImage("/test-images/1");
        ADS_DTO.setPk(1);
        ...
        FULL_ADS_DTO.setImage("/test-images/1");
        ...
        NEW_PASSWORD_DTO.setCurrentPassword("11111111");
